...
const Index = () => {
  return (
    <>
      <Helmet>
        <title>Global Success Guidance | Book Your Free Consultation Today</title>
        <meta
          name="description"
          content="Achieve your goals with expert guidance for study, work, and relocation to the USA, Canada, or Australia. Get personalized support every step of the way."
        />
        <meta
          name="keywords"
          content="study abroad, migration, international career, Canada, USA, Australia, global success, free consultation"
        />
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-4xl lg:text-6xl font-extrabold text-gray-900 mb-6 leading-tight">
                Achieve Your <span className="text-blue-600">Global Success</span><br />
                with <span className="text-red-600">Expert Guidance</span>
              </h1>

              <p className="text-lg lg:text-xl text-gray-600 mb-8 max-w-xl mx-auto">
                Personalized support to unlock your dream career or education path in the USA, Canada, or Australia.
              </p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg lg:text-xl mb-8 opacity-90 max-w-2xl mx-auto">
                Book a free consultation today and let our experts guide you to your future in the USA, Canada, or Australia.
              </p>
